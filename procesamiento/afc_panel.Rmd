...
ola1<-read_dta(here::here("input/data/proc/data_01.dta"))
ola2<-read_dta(here::here("input/data/proc/data_02.dta"))
ola3<-read_dta(here::here("input/data/proc/data_03.dta"))
data_wide <- full_join(
  x = ola1,
  #datos ola 1
  y = ola2,
