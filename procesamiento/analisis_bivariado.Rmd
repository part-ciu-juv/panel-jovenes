...
pond1 <- stats::weighted.mean(x=data_nunca$part_act_dis_21_1s,y=data_nunca$weight_w02,na.rm=TRUE)
pond2 <- stats::weighted.mean(x=data_casi_nunca$part_act_dis_21_1s,y=data_casi_nunca$weight_w02,na.rm=TRUE)
pond3 <- stats::weighted.mean(x=data_a_veces$part_act_dis_21_1s,y=data_a_veces$weight_w02,na.rm=TRUE)
pond4 <- stats::weighted.mean(x=data_frecuent$part_act_dis_21_1s,y=data_frecuent$weight_w02,na.rm=TRUE)
...
pond1 <- stats::weighted.mean(x=data_nunca$part_act_dis_21_2s,y=data_nunca$weight_w03,na.rm=TRUE)
pond2 <- stats::weighted.mean(x=data_casi_nunca$part_act_dis_21_2s,y=data_casi_nunca$weight_w03,na.rm=TRUE)
pond3 <- stats::weighted.mean(x=data_a_veces$part_act_dis_21_2s,y=data_a_veces$weight_w03,na.rm=TRUE)
pond4 <- stats::weighted.mean(x=data_frecuent$part_act_dis_21_2s,y=data_frecuent$weight_w03,na.rm=TRUE)
...
```
![](../output/graphs/part_act_no_dis.png)
...
En términos generales, no es posible visualizar un patrón claro de la relación entre ambas variables. En otras palabras, los resultados expuestos en los gráficos no evidencian una relación consistente entre el nivel educativo de la madre y la participación no disruptiva. Sin embargo, se ve una relación entre que la madre tenga educación media o terciaria y haber participado en una marcha pacífica durante el estallido social, así como también entre que la madre tenga educación básica o menos y haber participado en una marcha pacífica durante el primer semestre de 2021.
...
En esta sección se presentan los resultados descriptivos de la relación entre la frecuencia de conversación con los padres sobre temas sociales y/o políticos en cada uno de los momentos sobre los que se consultó y la participación activista no disruptiva del encuestado.

En términos generales, es posible visualizar una relación entre la frecuencia de conversación con los padres sobre estas temáticas y realizar prácticas de activismo no disruptivo en todos los momentos sobre los que se consultó.
...
pond1 <- stats::weighted.mean(x=data_nunca$part_act_no_dis_21_1s,y=data_nunca$weight_w02,na.rm=TRUE)
pond2 <- stats::weighted.mean(x=data_casi_nunca$part_act_no_dis_21_1s,y=data_casi_nunca$weight_w02,na.rm=TRUE)
pond3 <- stats::weighted.mean(x=data_a_veces$part_act_no_dis_21_1s,y=data_a_veces$weight_w02,na.rm=TRUE)
pond4 <- stats::weighted.mean(x=data_frecuent$part_act_no_dis_21_1s,y=data_frecuent$weight_w02,na.rm=TRUE)
...
pond1 <- stats::weighted.mean(x=data_nunca$part_act_no_dis_21_2s,y=data_nunca$weight_w03,na.rm=TRUE)
pond2 <- stats::weighted.mean(x=data_casi_nunca$part_act_no_dis_21_2s,y=data_casi_nunca$weight_w03,na.rm=TRUE)
pond3 <- stats::weighted.mean(x=data_a_veces$part_act_no_dis_21_2s,y=data_a_veces$weight_w03,na.rm=TRUE)
pond4 <- stats::weighted.mean(x=data_frecuent$part_act_no_dis_21_2s,y=data_frecuent$weight_w03,na.rm=TRUE)
...
pond1 <- stats::weighted.mean(x=data_nunca$part_act_online_21_1s,y=data_nunca$weight_w02,na.rm=TRUE)
pond2 <- stats::weighted.mean(x=data_casi_nunca$part_act_online_21_1s,y=data_casi_nunca$weight_w02,na.rm=TRUE)
pond3 <- stats::weighted.mean(x=data_a_veces$part_act_online_21_1s,y=data_a_veces$weight_w02,na.rm=TRUE)
pond4 <- stats::weighted.mean(x=data_frecuent$part_act_online_21_1s,y=data_frecuent$weight_w02,na.rm=TRUE)
...
pond1 <- stats::weighted.mean(x=data_nunca$part_act_online_21_2s,y=data_nunca$weight_w03,na.rm=TRUE)
pond2 <- stats::weighted.mean(x=data_casi_nunca$part_act_online_21_2s,y=data_casi_nunca$weight_w03,na.rm=TRUE)
pond3 <- stats::weighted.mean(x=data_a_veces$part_act_online_21_2s,y=data_a_veces$weight_w03,na.rm=TRUE)
pond4 <- stats::weighted.mean(x=data_frecuent$part_act_online_21_2s,y=data_frecuent$weight_w03,na.rm=TRUE)
...
En esta sección se presentan los resultados descriptivos de la relación entre la frecuencia de conversación con los padres sobre temas sociales y/o políticos **durante tercero y cuarto medio** y la participación en distintas votaciones.

En términos generales, es posible visualizar que no hay un patrón claro de la relación entre ambas variables. En otras palabras, los resultados expuestos en los gráficos no evidencian una relación consistente entre la frecuencia de conversación con los padres sobre temas sociales y/o políticos **durante tercero y cuarto medio** y la participación en elecciones. Sin embargo, al comparar las dos categorías extremas, se ve que quienes señalan nunca haber conversado sobre estas temáticas tienen una mayor proporción de personas que declaran no haber votado y que entre quienes declararon conversar frecuentemente sobre estas temáticas hay una mayor proporción de personas que señala sí haber votado.
...
En esta sección se presentan los resultados descriptivos de la relación entre la frecuencia de conversación con los padres sobre temas sociales y/o políticos **durante el estallido social** y la participación en distintas votaciones.

En términos generales, es posible visualizar una relación directa entre la frecuencia de conversación con los padres sobre estas temáticas **durante el estallido social** y la participación en todas las elecciones sobre las que se consultó. 
...
En esta sección se presentan los resultados descriptivos de la relación entre la frecuencia de conversación con los padres sobre temas sociales y/o políticos **durante el 2020** y la participación en distintas votaciones.

En términos generales, es posible visualizar una relación directa entre la frecuencia de conversación con los padres sobre estas temáticas **durante el 2020** y la participación en todas las elecciones sobre las que se consultó. 
...
En esta sección se presentan los resultados descriptivos de la relación entre la frecuencia de conversación con los padres sobre temas sociales y/o políticos **durante el primer semestre del 2021** y la participación en distintas votaciones.

En términos generales, es posible visualizar que no hay un patrón claro de la relación entre ambas variables. En otras palabras, los resultados expuestos en los gráficos no evidencian una relación consistente entre la frecuencia de conversación con los padres sobre temas sociales y/o políticos **durante el primer semestre del 2021** y la participación en elecciones. Sin embargo, al comparar las dos categorías extremas, se ve que quienes señalan nunca haber conversado sobre estas temáticas tienen una mayor proporción de personas que declaran no haber votado y que entre quienes declararon conversar frecuentemente sobre estas temáticas hay una mayor proporción de personas que señala sí haber votado.
...
En esta sección se presentan los resultados descriptivos de la relación entre la frecuencia de conversación con los padres sobre temas sociales y/o políticos **durante el segundo semestre del 2021** y la participación en distintas votaciones.

En términos generales, es posible visualizar una relación directa entre la frecuencia de conversación con los padres sobre estas temáticas **durante el segundo semestre del 2021** y la participación en todas las elecciones sobre las que se consultó. 
...
La participación activista se midió a través de un indicador que se presentan bajo la pregunta general "¿con qué frecuencia realizó las siguientes actividades? - Hablar con sus padres sobre temas sociales y/o políticos", teniendo como alternativas de respuesta *1. Nunca, 2. Casi nunca, 3. A veces, y 4. Frecuentemente*. 

Se presentó la misma pregunta para consultar por distintos momentos en el tiempo. Más específicamente, se consultó por la frecuencia de conversación con los padres sobre temas sociales y/o políticos: (1) el periodo en que el encuestado cursaba 3° y 4° Medio, (2) estallido social, (3) el año 2020, (4) el primer semestre de 2021 y (5) el segundo semestre de 2021.

En el gráfico a continuación se presenta el puntaje promedio de frecuencia de conversación con los padres sobre temas sociales y/o políticos en cada uno de los momentos sobre los que se consultó. Como se puede ver, la frecuencia de conversación sobre estas temáticas en general alcanza niveles altos (todos los promedios se encuentran entre 2.7 y 3.3). Los niveles más altos de frecuencia de conversación con los padres sobre temas sociales y/o políticos corresponden al 2020, al segundo semestre de 2021 y al periodo del estallido social.

```{r}
### durante 3ro y 4to medio
### conv_padr_poli
...
```{r}
table_preposh1<- rbind(psych::describe(data_wide$conv_padr_poli, na.rm=T),
               psych::describe(data_wide$conv_padres_21, na.rm=T),
               psych::describe(data_wide$conv_padres_20, na.rm=T),
               psych::describe(data_wide$conv_padres, na.rm=T),
               psych::describe(data_wide$conv_padres_21b, na.rm=T))

table_preposh1 <- table_preposh1 %>% select(n,mean,sd,median,trimmed,min,max)
pond1 <- stats::weighted.mean(x=data_wide$conv_padr_poli,y=data_wide$weight_w01,na.rm=TRUE)
pond2 <- stats::weighted.mean(x=data_wide$conv_padres_21,y=data_wide$weight_w01,na.rm=TRUE)
pond3 <- stats::weighted.mean(x=data_wide$conv_padres_20,y=data_wide$weight_w01,na.rm=TRUE)
pond4 <- stats::weighted.mean(x=data_wide$conv_padres,y=data_wide$weight_w02,na.rm=TRUE)
pond5 <- stats::weighted.mean(x=data_wide$conv_padres_21b,y=data_wide$weight_w03,na.rm=TRUE)
...
frec_conv <-  ggplot(data=table_preposh1, aes(x=dep, y=mean, fill=dep)) +
     geom_bar(position = 'dodge', stat='identity')+#,width=0.8) 
     scale_fill_brewer(palette="Purples") +
     geom_text(aes(label=format(round(mean,2)), y=0), position=position_dodge(0.9), hjust=-0.25, size=6) +
     theme_bw(base_size = 14) +
     scale_y_continuous(labels = scales::comma) +
     ylab('Puntaje promedio en la frecuencia de conversación 
(escala de 1 a 4)') + xlab(' ') + 
     theme(legend.position="top") +
     labs(fill = " ") +
    coord_flip()+
    theme(axis.text.x = element_text(colour = "grey20", size = 14, angle = 360, hjust = 0.5, vjust = 0.5, face = "bold"),
          ...
          plot.title = element_text(hjust=0.5),
          legend.position = "none") + 
     ggtitle("Frecuencia de conversación con los padres sobre 
temas sociales y/o políticos") + ylim(0,4)
ggsave(frec_conv, file = "../output/graphs/frec_conv.png",device = "png",width = 23,height = 13,dpi = "retina",units = "cm")
```
![](../output/graphs/frec_conv.png)

## Dependencia administrativa establecimiento

En esta sección se presentan los resultados descriptivos de la relación entre la dependencia administrativa del establecimiento en que el encuestado estudió sus dos últimos años de enseñanza media y la frecuencia de conversación con los padres sobre temas sociales y/o políticos durante los distintos momentos sobre los que se consultó.

En términos generales, es posible visualizar que hay una leve relación entre ambas variables. Es posible visualizar en los cinco momentos un patrón donde quienes provienen de establecimientos particulares privados son los que presentan un promedio más alto de conversación con sus padres sobre temas sociales y/o políticos, seguidos de quienes estudiaron en establecimientos particulares subvencionados. Mientras que quienes asistieron a establecimientos municipales son los que presentan un nivel más bajo de frecuencia de conversación sobre estas temáticas.
...
```{r}
table_preposh1<- rbind(psych::describe(data_mun$conv_padr_poli, na.rm=T),
               psych::describe(data_sub$conv_padr_poli, na.rm=T),psych::describe(data_priv$conv_padr_poli, na.rm=T))
table_preposh1 <- table_preposh1 %>% select(n,mean,sd,median,trimmed,min,max)
pond1 <- stats::weighted.mean(x=data_mun$conv_padr_poli,y=data_mun$weight_w01,na.rm=TRUE)
pond2 <- stats::weighted.mean(x=data_sub$conv_padr_poli,y=data_sub$weight_w01,na.rm=TRUE)
pond3 <- stats::weighted.mean(x=data_priv$conv_padr_poli,y=data_priv$weight_w01,na.rm=TRUE)
...
conv_padr_poli_colegio <-  ggplot(data=table_preposh1, aes(x=dep, y=mean, fill=dep)) +
     geom_bar(position = 'dodge', stat='identity')+#,width=0.8) 
     scale_fill_brewer(palette="Purples") +
     geom_text(aes(label=format(round(mean,2)), y=0), position=position_dodge(0.9), hjust=-0.25, size=6) +
     theme_bw(base_size = 14) +
...
(escala de 1 a 4)') + xlab(' ') + 
    ...
    theme(axis.text.x = element_text(colour = "grey20", size = 14, angle = 360, hjust = 0.5, vjust = 0.5, face = "bold"),
          ...
          legend.position = "none") + 
     ggtitle("Frecuencia de conversación con los padres sobre 
temas sociales y/o políticos por 
tipo de dependencia administrativa de la escuela") + ylim(0,4)
#conv_padr_poli_colegio
ggsave(conv_padr_poli_colegio, file = "../output/graphs/frec_conv_3y4_colegio_dep.png",device = "png",width = 23,height = 13,dpi = "retina",units = "cm")
```

![](../output/graphs/frec_conv_3y4_colegio_dep.png)
...
```{r}
table_preposh1<- rbind(psych::describe(data_mun$conv_padres_21, na.rm=T),
               psych::describe(data_sub$conv_padres_21, na.rm=T),psych::describe(data_priv$conv_padres_21, na.rm=T))
table_preposh1 <- table_preposh1 %>% select(n,mean,sd,median,trimmed,min,max)
pond1 <- stats::weighted.mean(x=data_mun$conv_padres_21,y=data_mun$weight_w01,na.rm=TRUE)
pond2 <- stats::weighted.mean(x=data_sub$conv_padres_21,y=data_sub$weight_w01,na.rm=TRUE)
pond3 <- stats::weighted.mean(x=data_priv$conv_padres_21,y=data_priv$weight_w01,na.rm=TRUE)
...
conv_padres_21_colegio <-  ggplot(data=table_preposh1, aes(x=dep, y=mean, fill=dep)) +
     geom_bar(position = 'dodge', stat='identity')+#,width=0.8) 
     scale_fill_brewer(palette="Purples") +
     geom_text(aes(label=format(round(mean,2)), y=0), position=position_dodge(0.9), hjust=-0.25, size=6) +
     theme_bw(base_size = 14) +
...
temas sociales y/o políticos por 
tipo de dependencia administrativa de la escuela") + ylim(0,4)
#conv_padres_21_colegio
ggsave(conv_padres_21_colegio, file = "../output/graphs/frec_conv_est_19_colegio_dep.png",device = "png",width = 23,height = 13,dpi = "retina",units = "cm")
```

![](../output/graphs/frec_conv_est_19_colegio_dep.png)

### Frecuencia de conversación con los padres sobre temas sociales y/o políticos en el 2020 
...
```{r}
table_preposh1<- rbind(psych::describe(data_mun$conv_padres_20, na.rm=T),
               psych::describe(data_sub$conv_padres_20, na.rm=T),psych::describe(data_priv$conv_padres_20, na.rm=T))
table_preposh1 <- table_preposh1 %>% select(n,mean,sd,median,trimmed,min,max)
pond1 <- stats::weighted.mean(x=data_mun$conv_padres_20,y=data_mun$weight_w01,na.rm=TRUE)
pond2 <- stats::weighted.mean(x=data_sub$conv_padres_20,y=data_sub$weight_w01,na.rm=TRUE)
pond3 <- stats::weighted.mean(x=data_priv$conv_padres_20,y=data_priv$weight_w01,na.rm=TRUE)
...
conv_padres_20_colegio <-  ggplot(data=table_preposh1, aes(x=dep, y=mean, fill=dep)) +
     geom_bar(position = 'dodge', stat='identity')+#,width=0.8) 
     scale_fill_brewer(palette="Purples") +
     geom_text(aes(label=format(round(mean,2)), y=0), position=position_dodge(0.9), hjust=-0.25, size=6) +
     theme_bw(base_size = 14) +
...
temas sociales y/o políticos por 
tipo de dependencia administrativa de la escuela") + ylim(0,4)
#conv_padres_20_colegio
ggsave(conv_padres_20_colegio, file = "../output/graphs/frec_conv_20_colegio_dep.png",device = "png",width = 23,height = 13,dpi = "retina",units = "cm")
```

![](../output/graphs/frec_conv_20_colegio_dep.png)
...
```{r}
table_preposh1<- rbind(psych::describe(data_mun$conv_padres, na.rm=T),
               psych::describe(data_sub$conv_padres, na.rm=T),psych::describe(data_priv$conv_padres, na.rm=T))
table_preposh1 <- table_preposh1 %>% select(n,mean,sd,median,trimmed,min,max)
pond1 <- stats::weighted.mean(x=data_mun$conv_padres,y=data_mun$weight_w02,na.rm=TRUE)
pond2 <- stats::weighted.mean(x=data_sub$conv_padres,y=data_sub$weight_w02,na.rm=TRUE)
pond3 <- stats::weighted.mean(x=data_priv$conv_padres,y=data_priv$weight_w02,na.rm=TRUE)
...
conv_padres_colegio <-  ggplot(data=table_preposh1, aes(x=dep, y=mean, fill=dep)) +
     geom_bar(position = 'dodge', stat='identity')+#,width=0.8) 
     scale_fill_brewer(palette="Purples") +
     geom_text(aes(label=format(round(mean,2)), y=0), position=position_dodge(0.9), hjust=-0.25, size=6) +
     theme_bw(base_size = 14) +
...
tipo de dependencia administrativa de la escuela") + ylim(0,4)
#conv_padres_colegio
ggsave(conv_padres_colegio, file = "../output/graphs/frec_conv_21a_colegio_dep.png",device = "png",width = 23,height = 13,dpi = "retina",units = "cm")
```

![](../output/graphs/frec_conv_21a_colegio_dep.png)
...
```{r}
table_preposh1<- rbind(psych::describe(data_mun$conv_padres_21b, na.rm=T),
               psych::describe(data_sub$conv_padres_21b, na.rm=T),psych::describe(data_priv$conv_padres_21b, na.rm=T))
table_preposh1 <- table_preposh1 %>% select(n,mean,sd,median,trimmed,min,max)
pond1 <- stats::weighted.mean(x=data_mun$conv_padres_21b,y=data_mun$weight_w03,na.rm=TRUE)
pond2 <- stats::weighted.mean(x=data_sub$conv_padres_21b,y=data_sub$weight_w03,na.rm=TRUE)
pond3 <- stats::weighted.mean(x=data_priv$conv_padres_21b,y=data_priv$weight_w03,na.rm=TRUE)
...
conv_padres_21b_colegio <-  ggplot(data=table_preposh1, aes(x=dep, y=mean, fill=dep)) +
     geom_bar(position = 'dodge', stat='identity')+#,width=0.8) 
     scale_fill_brewer(palette="Purples") +
     geom_text(aes(label=format(round(mean,2)), y=0), position=position_dodge(0.9), hjust=-0.25, size=6) +
     theme_bw(base_size = 14) +
...
temas sociales y/o políticos por 
tipo de dependencia administrativa de la escuela") + ylim(0,4)
#conv_padres_21b_colegio
ggsave(conv_padres_21b_colegio, file = "../output/graphs/frec_conv_21b_colegio_dep.png",device = "png",width = 23,height = 13,dpi = "retina",units = "cm")
```

![](../output/graphs/frec_conv_21b_colegio_dep.png)

## Máximo nivel educativo de la madre

En esta sección se presentan los resultados descriptivos de la relación entre el máximo nivel educativo de la madre y la frecuencia de conversación con los padres sobre temas sociales y/o políticos durante los distintos momentos sobre los que se consultó.

En términos generales, es posible visualizar una relación directa entre el nivel educativo de la madre y la frecuencia de conversación con los padres sobre estas temáticas en los cinco momentos sobre los que se consultó. 
...
```{r}
table_preposh1<- rbind(psych::describe(data_ed_bas$conv_padr_poli, na.rm=T),
               psych::describe(data_ed_med$conv_padr_poli, na.rm=T),
               psych::describe(data_ed_ter$conv_padr_poli, na.rm=T))#,
#               psych::describe(data_ed_uni$conv_padr_poli, na.rm=T))
table_preposh1 <- table_preposh1 %>% select(n,mean,sd,median,trimmed,min,max)

pond1 <- stats::weighted.mean(x=data_ed_bas$conv_padr_poli,y=data_ed_bas$weight_w01,na.rm=TRUE)
pond2 <- stats::weighted.mean(x=data_ed_med$conv_padr_poli,y=data_ed_med$weight_w01,na.rm=TRUE)
pond3 <- stats::weighted.mean(x=data_ed_ter$conv_padr_poli,y=data_ed_ter$weight_w01,na.rm=TRUE)
#pond4 <- stats::weighted.mean(x=data_ed_uni$conv_padr_poli,y=data_ed_uni$weight_w01,na.rm=TRUE)
...
nivel educativo de la madre") + ylim(0,4)
#conv_padr_poli_colegio
ggsave(conv_padr_poli_colegio, file = "../output/graphs/frec_conv_3y4_ed_madre.png",device = "png",width = 23,height = 13,dpi = "retina",units = "cm")

```

![](../output/graphs/frec_conv_3y4_ed_madre.png)
...
```{r}
table_preposh1<- rbind(psych::describe(data_ed_bas$conv_padres_21, na.rm=T),
               psych::describe(data_ed_med$conv_padres_21, na.rm=T),
               psych::describe(data_ed_ter$conv_padres_21, na.rm=T))#,
#               psych::describe(data_ed_uni$conv_padres_21, na.rm=T))
table_preposh1 <- table_preposh1 %>% select(n,mean,sd,median,trimmed,min,max)

pond1 <- stats::weighted.mean(x=data_ed_bas$conv_padres_21,y=data_ed_bas$weight_w01,na.rm=TRUE)
pond2 <- stats::weighted.mean(x=data_ed_med$conv_padres_21,y=data_ed_med$weight_w01,na.rm=TRUE)
pond3 <- stats::weighted.mean(x=data_ed_ter$conv_padres_21,y=data_ed_ter$weight_w01,na.rm=TRUE)
#pond4 <- stats::weighted.mean(x=data_ed_uni$conv_padres_21,y=data_ed_uni$weight_w01,na.rm=TRUE)
...
nivel educativo de la madre") + ylim(0,4)
#conv_padres_21_colegio
ggsave(conv_padres_21_colegio, file = "../output/graphs/frec_conv_est_19_ed_madre.png",device = "png",width = 23,height = 13,dpi = "retina",units = "cm")
```
![](../output/graphs/frec_conv_est_19_ed_madre.png)
...
```{r}
table_preposh1<- rbind(psych::describe(data_ed_bas$conv_padres_20, na.rm=T),
               psych::describe(data_ed_med$conv_padres_20, na.rm=T),
               psych::describe(data_ed_ter$conv_padres_20, na.rm=T))#,
#               psych::describe(data_ed_uni$conv_padres_20, na.rm=T))
table_preposh1 <- table_preposh1 %>% select(n,mean,sd,median,trimmed,min,max)

pond1 <- stats::weighted.mean(x=data_ed_bas$conv_padres_20,y=data_ed_bas$weight_w01,na.rm=TRUE)
pond2 <- stats::weighted.mean(x=data_ed_med$conv_padres_20,y=data_ed_med$weight_w01,na.rm=TRUE)
pond3 <- stats::weighted.mean(x=data_ed_ter$conv_padres_20,y=data_ed_ter$weight_w01,na.rm=TRUE)
#pond4 <- stats::weighted.mean(x=data_ed_uni$conv_padres_20,y=data_ed_uni$weight_w01,na.rm=TRUE)
...
nivel educativo de la madre") + ylim(0,4)
#conv_padres_20_colegio
ggsave(conv_padres_20_colegio, file = "../output/graphs/frec_conv_20_ed_madre.png",device = "png",width = 23,height = 13,dpi = "retina",units = "cm")
```

![](../output/graphs/frec_conv_20_ed_madre.png)
...
```{r}
table_preposh1<- rbind(psych::describe(data_ed_bas$conv_padres, na.rm=T),
               psych::describe(data_ed_med$conv_padres, na.rm=T),
               psych::describe(data_ed_ter$conv_padres, na.rm=T))#,
#               psych::describe(data_ed_uni$conv_padres, na.rm=T))
table_preposh1 <- table_preposh1 %>% select(n,mean,sd,median,trimmed,min,max)

pond1 <- stats::weighted.mean(x=data_ed_bas$conv_padres,y=data_ed_bas$weight_w02,na.rm=TRUE)
pond2 <- stats::weighted.mean(x=data_ed_med$conv_padres,y=data_ed_med$weight_w02,na.rm=TRUE)
pond3 <- stats::weighted.mean(x=data_ed_ter$conv_padres,y=data_ed_ter$weight_w02,na.rm=TRUE)
#pond4 <- stats::weighted.mean(x=data_ed_uni$conv_padres,y=data_ed_uni$weight_w02,na.rm=TRUE)
...
nivel educativo de la madre") + ylim(0,4)
#conv_padres_colegio
ggsave(conv_padres_colegio, file = "../output/graphs/frec_conv_21a_ed_madre.png",device = "png",width = 23,height = 13,dpi = "retina",units = "cm")
```

![](../output/graphs/frec_conv_21a_ed_madre.png)
...
```{r}
table_preposh1<- rbind(psych::describe(data_ed_bas$conv_padres_21b, na.rm=T),
               psych::describe(data_ed_med$conv_padres_21b, na.rm=T),
               psych::describe(data_ed_ter$conv_padres_21b, na.rm=T))#,
#               psych::describe(data_ed_uni$conv_padres_21b, na.rm=T))
table_preposh1 <- table_preposh1 %>% select(n,mean,sd,median,trimmed,min,max)

pond1 <- stats::weighted.mean(x=data_ed_bas$conv_padres_21b,y=data_ed_bas$weight_w03,na.rm=TRUE)
pond2 <- stats::weighted.mean(x=data_ed_med$conv_padres_21b,y=data_ed_med$weight_w03,na.rm=TRUE)
pond3 <- stats::weighted.mean(x=data_ed_ter$conv_padres_21b,y=data_ed_ter$weight_w03,na.rm=TRUE)
#pond4 <- stats::weighted.mean(x=data_ed_uni$conv_padres_21b,y=data_ed_uni$weight_w03,na.rm=TRUE)
...
nivel educativo de la madre") + ylim(0,4)
#conv_padres_21b_colegio
ggsave(conv_padres_21b_colegio, file = "../output/graphs/frec_conv_21b_ed_madre.png",device = "png",width = 23,height = 13,dpi = "retina",units = "cm")
```
![](../output/graphs/frec_conv_21b_ed_madre.png)

## Máximo nivel educativo del padre

En esta sección se presentan los resultados descriptivos de la relación entre el máximo nivel educativo del padre y la frecuencia de conversación con los padres sobre temas sociales y/o políticos durante los distintos momentos sobre los que se consultó.

En términos generales, es posible visualizar una relación directa entre el nivel educativo del padre y la frecuencia de conversación con los padres sobre estas temáticas en los cinco momentos sobre los que se consultó. 
...
nivel educativo del padre") + ylim(0,4)
#conv_padr_poli_colegio
ggsave(conv_padr_poli_colegio, file = "../output/graphs/frec_conv_3y4_ed_padre.png",device = "png",width = 23,height = 13,dpi = "retina",units = "cm")

```

![](../output/graphs/frec_conv_3y4_ed_padre.png)
...
nivel educativo del padre") + ylim(0,4)
#conv_padres_21_colegio
ggsave(conv_padres_21_colegio, file = "../output/graphs/frec_conv_est_19_ed_padre.png",device = "png",width = 23,height = 13,dpi = "retina",units = "cm")
```
![](../output/graphs/frec_conv_est_19_ed_padre.png)
...
nivel educativo del padre") + ylim(0,4)
#conv_padres_20_colegio
ggsave(conv_padres_20_colegio, file = "../output/graphs/frec_conv_20_ed_padre.png",device = "png",width = 23,height = 13,dpi = "retina",units = "cm")
```

![](../output/graphs/frec_conv_20_ed_padre.png)
...
nivel educativo del padre") + ylim(0,4)
#conv_padres_colegio
ggsave(conv_padres_colegio, file = "../output/graphs/frec_conv_21a_ed_padre.png",device = "png",width = 23,height = 13,dpi = "retina",units = "cm")
```

![](../output/graphs/frec_conv_21a_ed_padre.png)
...
nivel educativo del padre") + ylim(0,4)
#conv_padres_21b_colegio
ggsave(conv_padres_21b_colegio, file = "../output/graphs/frec_conv_21b_ed_padre.png",device = "png",width = 23,height = 13,dpi = "retina",units = "cm")
```
![](../output/graphs/frec_conv_21b_ed_padre.png)
