...
legend.position = "bottom", # legenda abajo
  ...
  guides(fill = guide_legend(reverse=TRUE)) +
     scale_fill_brewer(palette="Purples", labels = c("No tenía edad", "Sí", "No"))
...
bbdd_general =
  data_wide %>% group_by(voto_pres_17) %>%
             ...
             mutate(prop=round(n*100/sum(n),1))
bbdd_ed_bas =
  data_wide %>% filter(nse_madre==1 | nse_madre==2 | nse_madre==3) %>%
              group_by(voto_pres_17) %>% #pregunta a graficar
             summarise(n=n(), tipe="<span style='color:#FFFFFF'>a</span>Ed. básica <br>o menos") %>%
             mutate(prop=round(n*100/sum(n),1))
bbdd_ed_med =
  data_wide %>% filter(nse_madre==4 | nse_madre==5) %>%
              group_by(voto_pres_17) %>% #pregunta a graficar
             summarise(n=n(), tipe="<span style='color:#FFFFFF'>b</span>Ed. media") %>%
             mutate(prop=round(n*100/sum(n),1))
bbdd_ed_ter =
  data_wide %>% filter(nse_madre==6 | nse_madre==7 | nse_madre==8 | nse_madre==9 | nse_madre==10) %>%
              group_by(voto_pres_17) %>% #pregunta a graficar
...
bbdd_general =
  data_wide %>% group_by(voto_pres_17) %>%
             ...
             mutate(prop=round(n*100/sum(n),1))
bbdd_ed_bas =
  data_wide %>% filter(nse_padre==1 | nse_padre==2 | nse_padre==3) %>%
              group_by(voto_pres_17) %>% #pregunta a graficar
             summarise(n=n(), tipe="<span style='color:#FFFFFF'>a</span>Ed. básica <br>o menos") %>%
             mutate(prop=round(n*100/sum(n),1))
bbdd_ed_med =
  data_wide %>% filter(nse_padre==4 | nse_padre==5) %>%
              group_by(voto_pres_17) %>% #pregunta a graficar
             summarise(n=n(), tipe="<span style='color:#FFFFFF'>b</span>Ed. media") %>%
             mutate(prop=round(n*100/sum(n),1))
bbdd_ed_ter =
  data_wide %>% filter(nse_padre==6 | nse_padre==7 | nse_padre==8 | nse_padre==9 | nse_padre==10) %>%
              group_by(voto_pres_17) %>% #pregunta a graficar
             summarise(n=n(), tipe="<span style='color:#FFFFFF'>c</span>Ed. terciaria") %>%
             mutate(prop=round(n*100/sum(n),1))
...
bbdd_general =
  data_wide %>% group_by(voto_pres_17) %>%
             ...
             mutate(prop=round(n*100/sum(n),1))
bbdd_nunca =
  data_wide %>% filter(conv_padres_21==1) %>%
              group_by(voto_pres_17) %>% #pregunta a graficar
             summarise(n=n(), tipe="<span style='color:#FFFFFF'>d</span>4. Nunca") %>%
             mutate(prop=round(n*100/sum(n),1))
bbdd_casi_nunca =
  data_wide %>% filter(conv_padres_21==2) %>%
              group_by(voto_pres_17) %>% #pregunta a graficar
             summarise(n=n(), tipe="<span style='color:#FFFFFF'>c</span>3. Casi nunca") %>%
             mutate(prop=round(n*100/sum(n),1))
bbdd_a_veces =
  data_wide %>% filter(conv_padres_21==3) %>%
              group_by(voto_pres_17) %>% #pregunta a graficar
             summarise(n=n(), tipe="<span style='color:#FFFFFF'>b</span>2. A veces") %>%
             mutate(prop=round(n*100/sum(n),1))
bbdd_frecuent =
  data_wide %>% filter(conv_padres_21==4) %>%
              group_by(voto_pres_17) %>% #pregunta a graficar
             summarise(n=n(), tipe="<span style='color:#FFFFFF'>a</span>1. Frecuentemente") %>%
             mutate(prop=round(n*100/sum(n),1))
...
bbdd_general =
  data_wide %>% group_by(voto_pres_17) %>%
             ...
             mutate(prop=round(n*100/sum(n),1))
bbdd_nunca =
  data_wide %>% filter(conv_padres_20==1) %>%
              group_by(voto_pres_17) %>% #pregunta a graficar
             summarise(n=n(), tipe="<span style='color:#FFFFFF'>d</span>4. Nunca") %>%
             mutate(prop=round(n*100/sum(n),1))
bbdd_casi_nunca =
  data_wide %>% filter(conv_padres_20==2) %>%
              group_by(voto_pres_17) %>% #pregunta a graficar
             summarise(n=n(), tipe="<span style='color:#FFFFFF'>c</span>3. Casi nunca") %>%
             mutate(prop=round(n*100/sum(n),1))
bbdd_a_veces =
  data_wide %>% filter(conv_padres_20==3) %>%
              group_by(voto_pres_17) %>% #pregunta a graficar
             summarise(n=n(), tipe="<span style='color:#FFFFFF'>b</span>2. A veces") %>%
             mutate(prop=round(n*100/sum(n),1))
bbdd_frecuent =
  data_wide %>% filter(conv_padres_20==4) %>%
              group_by(voto_pres_17) %>% #pregunta a graficar
             summarise(n=n(), tipe="<span style='color:#FFFFFF'>a</span>1. Frecuentemente") %>%
             mutate(prop=round(n*100/sum(n),1))
...
bbdd_general =
  data_wide %>% group_by(voto_pres_17) %>%
             ...
             mutate(prop=round(n*100/sum(n),1))
bbdd_nunca =
  data_wide %>% filter(conv_padres==1) %>%
              group_by(voto_pres_17) %>% #pregunta a graficar
             summarise(n=n(), tipe="<span style='color:#FFFFFF'>d</span>4. Nunca") %>%
             mutate(prop=round(n*100/sum(n),1))
bbdd_casi_nunca =
  data_wide %>% filter(conv_padres==2) %>%
              group_by(voto_pres_17) %>% #pregunta a graficar
             summarise(n=n(), tipe="<span style='color:#FFFFFF'>c</span>3. Casi nunca") %>%
             mutate(prop=round(n*100/sum(n),1))
bbdd_a_veces =
  data_wide %>% filter(conv_padres==3) %>%
              group_by(voto_pres_17) %>% #pregunta a graficar
             summarise(n=n(), tipe="<span style='color:#FFFFFF'>b</span>2. A veces") %>%
             mutate(prop=round(n*100/sum(n),1))
bbdd_frecuent =
  data_wide %>% filter(conv_padres==4) %>%
              group_by(voto_pres_17) %>% #pregunta a graficar
             summarise(n=n(), tipe="<span style='color:#FFFFFF'>a</span>1. Frecuentemente") %>%
             mutate(prop=round(n*100/sum(n),1))
...
bbdd_general =
  data_wide %>% group_by(voto_pres_17) %>%
             ...
             mutate(prop=round(n*100/sum(n),1))
bbdd_nunca =
  data_wide %>% filter(conv_padres_21b==1) %>%
              group_by(voto_pres_17) %>% #pregunta a graficar
             summarise(n=n(), tipe="<span style='color:#FFFFFF'>d</span>4. Nunca") %>%
             mutate(prop=round(n*100/sum(n),1))
bbdd_casi_nunca =
  data_wide %>% filter(conv_padres_21b==2) %>%
              group_by(voto_pres_17) %>% #pregunta a graficar
             summarise(n=n(), tipe="<span style='color:#FFFFFF'>c</span>3. Casi nunca") %>%
             mutate(prop=round(n*100/sum(n),1))
bbdd_a_veces =
  data_wide %>% filter(conv_padres_21b==3) %>%
              group_by(voto_pres_17) %>% #pregunta a graficar
             summarise(n=n(), tipe="<span style='color:#FFFFFF'>b</span>2. A veces") %>%
             mutate(prop=round(n*100/sum(n),1))
bbdd_frecuent =
  data_wide %>% filter(conv_padres_21b==4) %>%
              group_by(voto_pres_17) %>% #pregunta a graficar
             summarise(n=n(), tipe="<span style='color:#FFFFFF'>a</span>1. Frecuentemente") %>%
             mutate(prop=round(n*100/sum(n),1))
...
bbdd_general =
  data_wide %>% group_by(voto_privuelta) %>%
             summarise(n=n(), tipe="<span style='color:#FFFFFF'>e</span>General") %>%
             mutate(prop=round(n*100/sum(n),1))
bbdd_mun =
  data_wide %>% filter(edm_admi==1) %>%
...
bbdd_general =
  data_wide %>% group_by(voto_segvuelta) %>%
             summarise(n=n(), tipe="<span style='color:#FFFFFF'>e</span>General") %>%
             mutate(prop=round(n*100/sum(n),1))
bbdd_mun =
  data_wide %>% filter(edm_admi==1) %>%
...
elec_int_pres21_dep <- bbdd_grafico %>% ggplot2::ggplot(aes(x=prop,y=tipe,fill=as.character(voto_fut.x	))) +  geom_bar(stat="identity",width = 0.5) +
  xlab("Porcentaje de respuestas según alternativa") +
  ylab("") +
  theme_minimal() +  # Fondo blanco con lineas
   geom_text(aes(x = prop, label = paste0(prop,"%")),
...
ggsave(elec_int_pres21_dep, file = "../output/graphs/elec_int_pres21_dep.jpg",device = "jpg",width = 23,height = 13,dpi = "retina",units = "cm")
```

![](../output/graphs/elec_int_pres21_dep.jpg)
...
bbdd_grafico = rbind(bbdd_general,bbdd_ed_ter,bbdd_ed_med,bbdd_ed_bas)
bbdd_grafico<-na.omit(bbdd_grafico)
elec_int_pres21_edmad <- bbdd_grafico %>% ggplot2::ggplot(aes(x=prop,y=tipe,fill=as.character(voto_fut.x	))) +  geom_bar(stat="identity",width = 0.5) +
  xlab("Porcentaje de respuestas según alternativa") +
  ylab("") +
  theme_minimal() +  # Fondo blanco con lineas
   geom_text(aes(x = prop, label = paste0(prop,"%")),
...
ggsave(elec_int_pres21_edmad, file = "../output/graphs/elec_int_pres21_edmad.jpg",device = "jpg",width = 23,height = 13,dpi = "retina",units = "cm")
```

![](../output/graphs/elec_int_pres21_edmad.jpg)
...
bbdd_grafico = rbind(bbdd_general,bbdd_ed_ter,bbdd_ed_med,bbdd_ed_bas)
bbdd_grafico<-na.omit(bbdd_grafico)
elec_int_pres21_edpad <- bbdd_grafico %>% ggplot2::ggplot(aes(x=prop,y=tipe,fill=as.character(voto_fut.x	))) +  geom_bar(stat="identity",width = 0.5) +
  xlab("Porcentaje de respuestas según alternativa") +
  ylab("") +
  theme_minimal() +  # Fondo blanco con lineas
   geom_text(aes(x = prop, label = paste0(prop,"%")),
...
ggsave(elec_int_pres21_edpad, file = "../output/graphs/elec_int_pres21_edpad.jpg",device = "jpg",width = 23,height = 13,dpi = "retina",units = "cm")
```

![](../output/graphs/elec_int_pres21_edpad.jpg)
...
elec_int_pres21_pad_3y4 <- bbdd_grafico %>% ggplot2::ggplot(aes(x=prop,y=tipe,fill=as.character(voto_fut.x))) +  geom_bar(stat="identity",width = 0.5) +
  xlab("Porcentaje de respuestas según alternativa") +
  ylab("") +
  theme_minimal() +  # Fondo blanco con lineas
   geom_text(aes(x = prop, label = paste0(prop,"%")),
...
ggsave(elec_int_pres21_pad_3y4, file = "../output/graphs/elec_int_pres21_pad_3y4.jpg",device = "jpg",width = 23,height = 13.5,dpi = "retina",units = "cm")
```

![](../output/graphs/elec_int_pres21_pad_3y4.jpg)
### Frecuencia de conversación con los padres sobre temas sociales y/o políticos en el estallido social
...
ggsave(elec_int_pres21_pad_3y4, file = "../output/graphs/elec_int_pres21_pad_est_19.jpg",device = "jpg",width = 23,height = 13.5,dpi = "retina",units = "cm")
```

![](../output/graphs/elec_int_pres21_pad_est_19.jpg)
### Frecuencia de conversación con los padres sobre temas sociales y/o políticos el 2020
...
ggsave(elec_int_pres21_pad_3y4, file = "../output/graphs/elec_int_pres21_pad_20.jpg",device = "jpg",width = 23,height = 13.5,dpi = "retina",units = "cm")
```

![](../output/graphs/elec_int_pres21_pad_20.jpg)
...
ggsave(elec_int_pres21_pad_3y4, file = "../output/graphs/elec_int_pres21_pad_21a.jpg",device = "jpg",width = 23,height = 13.5,dpi = "retina",units = "cm")
```

![](../output/graphs/elec_int_pres21_pad_21a.jpg)
...
ggsave(elec_int_pres21_pad_3y4, file = "../output/graphs/elec_int_pres21_pad_21b.jpg",device = "jpg",width = 23,height = 13.5,dpi = "retina",units = "cm")
```

![](../output/graphs/elec_int_pres21_pad_21b.jpg)
...
elec_int_pres21_dep <- bbdd_grafico %>% ggplot2::ggplot(aes(x=prop,y=tipe,fill=as.character(voto_fut.y	))) +  geom_bar(stat="identity",width = 0.5) +
  xlab("Porcentaje de respuestas según alternativa") +
  ylab("") +
  theme_minimal() +  # Fondo blanco con lineas
   geom_text(aes(x = prop, label = paste0(prop,"%")),
...
bbdd_grafico = rbind(bbdd_general,bbdd_ed_ter,bbdd_ed_med,bbdd_ed_bas)
bbdd_grafico<-na.omit(bbdd_grafico)
elec_int_pres21_edmad <- bbdd_grafico %>% ggplot2::ggplot(aes(x=prop,y=tipe,fill=as.character(voto_fut.y	))) +  geom_bar(stat="identity",width = 0.5) +
  xlab("Porcentaje de respuestas según alternativa") +
  ylab("") +
  theme_minimal() +  # Fondo blanco con lineas
   geom_text(aes(x = prop, label = paste0(prop,"%")),
...
bbdd_grafico = rbind(bbdd_general,bbdd_ed_ter,bbdd_ed_med,bbdd_ed_bas)
bbdd_grafico<-na.omit(bbdd_grafico)
elec_int_pres21_edpad <- bbdd_grafico %>% ggplot2::ggplot(aes(x=prop,y=tipe,fill=as.character(voto_fut.y	))) +  geom_bar(stat="identity",width = 0.5) +
  xlab("Porcentaje de respuestas según alternativa") +
  ylab("") +
  theme_minimal() +  # Fondo blanco con lineas
   geom_text(aes(x = prop, label = paste0(prop,"%")),
...
elec_int_pres21_pad_3y4 <- bbdd_grafico %>% ggplot2::ggplot(aes(x=prop,y=tipe,fill=as.character(voto_fut.y))) +  geom_bar(stat="identity",width = 0.5) +
  xlab("Porcentaje de respuestas según alternativa") +
  ylab("") +
  theme_minimal() +  # Fondo blanco con lineas
   geom_text(aes(x = prop, label = paste0(prop,"%")),
