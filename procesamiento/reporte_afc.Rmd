...
### Modelo de medición: invarianza longitudinal configural
```{r,results='asis'}
# Especificación del modelo
afc_invar_conf <- '
## 3° y 4°
act_disrup_w1 =~ part_pol_marcha_dis_w01 + part_pol_bloqueo_w01 + part_pol_rayar_w01 + part_pol_toma_w01
act_online_w1 =~ part_pol_online_w01 + part_online_post_w01 + part_online_com_w01 + part_online_seg_w01

## Estallido
act_disrup_w2 =~ part_pol_marc_dis_21_w01 + part_pol_bloq_21_w01 + part_pol_rayar_21_w01 + part_pol_toma_21_w01
act_online_w2 =~ part_pol_online_info_21_w01 + part_pol_online_post_21_w01 + part_pol_online_com_21_w01 + part_pol_online_seg_21_w01

## 2020 
act_disrup_w3 =~ part_pol_marc_dis_20_w01 + part_pol_bloq_20_w01 + part_pol_rayar_20_w01 + part_pol_toma_20_w01
act_online_w3 =~ part_pol_online_info_20_w01 + part_pol_online_post_20_w01 + part_pol_online_com_20_w01 + part_pol_online_seg_20_w01

## 2021 primer semestre
act_disrup_w4 =~ part_pol_marc_dis_w02 + part_pol_bloq_w02 + part_pol_rayar_w02 + part_pol_toma_w02
act_online_w4 =~ part_pol_online_info_w02 + part_pol_online_post_w02 + part_pol_online_com_w02 + part_pol_online_seg_w02

## 2021 segundo semestre 
act_disrup_w5 =~ part_pol_marc_dis_21b_w03 + part_pol_bloq_21b_w03 + part_pol_rayar_21b_w03 + part_pol_toma_21b_w03
act_online_w5 =~ part_pol_online_info_21b_w03 + part_pol_online_post_21b_w03 + part_pol_online_com_21b_w03 + part_pol_online_seg_21b_w03

## Covarianzas
part_pol_marcha_dis_w01 ~~ part_pol_marc_dis_21_w01

part_pol_bloqueo_w01 ~~ part_pol_bloq_21_w01

part_pol_rayar_w01 ~~ part_pol_rayar_21_w01

part_pol_toma_w01 ~~ part_pol_toma_21_w01

part_pol_online_w01 ~~ part_pol_online_info_21_w01

part_online_post_w01 ~~ part_pol_online_post_21_w01

part_online_com_w01 ~~ part_pol_online_com_21_w01

part_online_seg_w01 ~~ part_pol_online_seg_21_w01


part_pol_marc_dis_21_w01 ~~ part_pol_marc_dis_20_w01 

part_pol_bloq_21_w01 ~~ part_pol_bloq_20_w01 

part_pol_rayar_21_w01 ~~ part_pol_rayar_20_w01 

part_pol_toma_21_w01 ~~ part_pol_toma_20_w01 

part_pol_online_info_21_w01 ~~ part_pol_online_info_20_w01 

part_pol_online_post_21_w01 ~~ part_pol_online_post_20_w01 

part_pol_online_com_21_w01 ~~ part_pol_online_com_20_w01 

part_pol_online_seg_21_w01 ~~ part_pol_online_seg_20_w01


part_pol_marc_dis_20_w01 ~~ part_pol_marc_dis_w02 

part_pol_bloq_20_w01 ~~ part_pol_bloq_w02 

part_pol_rayar_20_w01 ~~ part_pol_rayar_w02 

part_pol_toma_20_w01 ~~ part_pol_toma_w02

part_pol_online_info_20_w01 ~~ part_pol_online_info_w02 

part_pol_online_post_20_w01 ~~ part_pol_online_post_w02 

part_pol_online_com_20_w01 ~~ part_pol_online_com_w02 

part_pol_online_seg_20_w01 ~~ part_pol_online_seg_w02


part_pol_marc_dis_w02 ~~ part_pol_marc_dis_21b_w03 

part_pol_bloq_w02 ~~ part_pol_bloq_21b_w03 

part_pol_rayar_w02 ~~ part_pol_rayar_21b_w03 

part_pol_toma_w02 ~~ part_pol_toma_21b_w03

part_pol_online_info_w02 ~~ part_pol_online_info_21b_w03 

part_pol_online_post_w02 ~~ part_pol_online_post_21b_w03

part_pol_online_com_w02 ~~ part_pol_online_com_21b_w03
part_pol_online_seg_w02 ~~ part_pol_online_seg_21b_w03

'

# Estimación del modelo
fit_invar_conf <- lavaan::cfa(afc_invar_conf, data = df_wide, ordered = T,
                     std.lv = TRUE , #factor loadings standarized
                     )
 lavaan::summary(fit_invar_conf, fit.measures = T, standardized = T)
# lavaan::fitMeasures(fit_invar, c("chisq", "df", "pvalue", "cfi", "tli", "rmsea"))

# create table report
semTable::semTable(
  fit_invar_conf ,columns =c("estse"),
...
### Modelo de medición: invarianza longitudinal métrico o débil
```{r,results='asis'}
# Especificación del modelo
afc_invar_metric <- '
## 3° y 4°
act_disrup_w1 =~ marcha*part_pol_marcha_dis_w01 + bloqueo*part_pol_bloqueo_w01 + rayar*part_pol_rayar_w01 + toma*part_pol_toma_w01
act_online_w1 =~ info*part_pol_online_w01 + post*part_online_post_w01 + comp*part_online_com_w01 + seguir*part_online_seg_w01

## Estallido
act_disrup_w2 =~ marcha*part_pol_marc_dis_21_w01 + bloqueo*part_pol_bloq_21_w01 + rayar*part_pol_rayar_21_w01 + toma*part_pol_toma_21_w01
act_online_w2 =~ info*part_pol_online_info_21_w01 + post*part_pol_online_post_21_w01 + comp*part_pol_online_com_21_w01 + seguir*part_pol_online_seg_21_w01

## 2020 
act_disrup_w3 =~ marcha*part_pol_marc_dis_20_w01 + bloqueo*part_pol_bloq_20_w01 + rayar*part_pol_rayar_20_w01 + toma*part_pol_toma_20_w01
act_online_w3 =~ info*part_pol_online_info_20_w01 + post*part_pol_online_post_20_w01 + comp*part_pol_online_com_20_w01 + seguir*part_pol_online_seg_20_w01

## 2021 primer semestre
act_disrup_w4 =~ marcha*part_pol_marc_dis_w02 + bloqueo*part_pol_bloq_w02 + rayar*part_pol_rayar_w02 + toma*part_pol_toma_w02
act_online_w4 =~ info*part_pol_online_info_w02 + post*part_pol_online_post_w02 + comp*part_pol_online_com_w02 + seguir*part_pol_online_seg_w02

## 2021 segundo semestre 
act_disrup_w5 =~ marcha*part_pol_marc_dis_21b_w03 + bloqueo*part_pol_bloq_21b_w03 + rayar*part_pol_rayar_21b_w03 + toma*part_pol_toma_21b_w03
act_online_w5 =~ info*part_pol_online_info_21b_w03 + post*part_pol_online_post_21b_w03 + comp*part_pol_online_com_21b_w03 + seguir*part_pol_online_seg_21b_w03
...
# Estimación del modelo
fit_invar_metric <- lavaan::cfa(afc_invar_metric, data = df_wide, ordered = T,
                     std.lv = TRUE , #factor loadings standarized
                     )
 lavaan::summary(fit_invar_metric, fit.measures = T, standardized = T)
# lavaan::fitMeasures(fit_invar, c("chisq", "df", "pvalue", "cfi", "tli", "rmsea"))

# create table report
semTable::semTable(
  fit_invar_metric ,columns =c("estse"),
  paramSets = c("loadings") ,
fits = c("chisq", "df", "pvalue", "cfi", "tli", "rmsea") ,
type = "html")
...
fit_invar <- list(fit_invar_conf, fit_invar_metric)
